...
public class NanoHTTPD
{
					...
					if(!mime.startsWith("multipart/x-mixed-replace")) {
						...
						while (true) {
							...
							if(pending == 0) {
								...
								MJpegStream in = (MJpegStream) data;
								byte[] jpegheader = in.getHeader();
								out.write(jpegheader, 0, jpegheader.length);
								out.flush();
								ByteBuffer buffer = in.getVideoBuffer();
								byte[] buf = buffer.array();
								out.write(buf, 0, buf.length);
								out.flush();
								in.clear();
								//Log.e(TAG, "mjpeg stream.......out.");
							} //if pending
						} // while
					} 
				} // if data
				Log.e(TAG, "mjpeg stream..............end!");
                out.flush();
                out.close();
	...
	private int theBufferSize = 30*1024;
